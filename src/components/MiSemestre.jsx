...
let jason = require("./../data/ramos.json");//leemos los datos de los ramos y, además, se tiene el contenido asociado a la sesión del alumno, en ramosMiSemestreMock.json, que aumenta mientras vayamos agregando ramos a la ventana miSemestre (nuestras sinceras disculpas, no fue explicado en el video)
...
const MiSemestre = () => {
  ...
  const addSubject = () => {//indicamos cual es la asignatura a guardar en miSemestre, mediante el uso de la sigla de esta. Con esto, se busca la información asociada al ramo, usando esta clave comparativa, en los datos disponibles en el json de los ramos, y se entregan como resultado de la búsqueda
    if (subject) {
  ...
  return (
    <div>
      ...
      <Container>
        <Row>{/*Al igual que la vista en AsignaturaDetalle, entregamos el componente que contiene la información que hemos solicitado (en este caso, el componente interactivo para acceder al contenido del ramo)*/}
      ...
      <Form>
        ...
        <Form.Group>
          <Form.Label>Customiza tu semestre como quieras! Agrega los links de imagenes que te gusten a tus ramos y ten un repositorio a tu estilo:
          </Form.Label>
